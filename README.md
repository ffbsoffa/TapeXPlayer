...
|----------|--------|--------------|-------|
| **macOS** | ✅ Available | Universal Binary (Intel + Apple Silicon) | Build 1841 |
| **Linux** | ✅ Available (DEB) | x86_64, ARM64 | Build 1843 |
| **Windows** | ✅ Available | x86_64, ARM64 | Builds 1841, 1842 |
